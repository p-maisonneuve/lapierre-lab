...
output = matrix(0,ncol = 5, nrow = 40)
...
for(i in 1:40)
{
  ...
  # 3 - Setting the depth at 1 meter
  z <- 1
...
write.csv(x = output, file = "Average_areal_light_dose_WaterColumn_1m.csv", fileEncoding = "UTF-8")
